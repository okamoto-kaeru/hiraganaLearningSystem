...
<form action="boardMain" style="margin: 0 0 0 auto;">
	<input type="text" name="word" style="width: 3rem; font-size: 0.2rem;">
	<input type="submit" class="button pinkButton adminSearch" value="검색" style="margin-top: -20px; margin-bottom: 0.2rem; font-size: 0.2rem; height: 0.4rem; width: 0.7rem; text-align: center;">
</form>
<c:forEach items="${boardList}" var="item">
	<div style="border: 1px solid #ccc; margin-bottom: 0.2rem;">
		<table class="table center responseTable" style="width: 100%; table-layout: fixed;">
			...
			<tr>
				...
				<td style="text-align: right; font-size: 0.13rem;">
					작성일: <fmt:formatDate value="${item.writeDate}" pattern="yyyy년 MM월 dd일"/>
				</td>
			</tr>
		</table>
	</div>
