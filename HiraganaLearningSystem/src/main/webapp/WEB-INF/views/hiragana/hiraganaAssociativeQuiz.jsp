...
<span id="amountOfQuiz" style="font-size: 0.35rem; margin-left: 0.5rem; position: absolute; top: 0.1rem; left: -0.3rem;">문제 1</span><span id="countDown" style="font-size: 0.5rem; margin-left: 0.5rem; position: absolute; top: 0.1rem; right: 0.3rem; color: #5151ff">시작!</span>
	<img id="image1" class="pointer imageButton" style="position: relative; right: 0.5rem;">
	<img id="image2" class="pointer imageButton" style="position: relative; left: 0.5rem;"><br>
	<img id="image3" class="pointer imageButton" style="position: relative; right: 1rem;">
	<img id="image4" class="pointer imageButton" style="position: relative;">
	<img id="image5" class="pointer imageButton" style="position: relative; left: 1rem;">
</div>
